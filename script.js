...
stimulate.onclick = () => {game.play(p1,p2)}
...
document.addEventListener('keydown', function(e) {
  ...
  if (e.key == 'q' && p2.health > 0 && resultDiv.innerText == '') {
    p1.strike(p1, p2, p1.attackDmg)
    document.getElementById('p1attack').play()
  } else if (e.key == 'p' && p1.health > 0 && resultDiv.innerText == '') {
    p2.strike(p2, p1, p2.attackDmg)
    document.getElementById('p2attack').play()
  } else if (e.key == 'a'  && resultDiv.innerText == '') {
    p1.heal(p1, p2)
    document.getElementById('p1heal').play()
  } else if (e.key == 'l'  && resultDiv.innerText == '') {
    p2.heal(p2, p1)
